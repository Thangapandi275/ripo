                     ...
                     <div class="row">
                        <div class="col-sm-6">
                           ...
                           <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item">Edit Sale</li>
                           </ol>
                        </div>
                        <div class="col-sm-6">
                           <!-- Bookmark Start-->
               ...
               <div class="container-fluid">
                  <div class="row">
                     ...
                     <div class="col-sm-12 col-xl-12">
                        ...
                        <form class="row" id="saleform" method="post" action="<?php echo base_url(); ?>sales/ediedSales" enctype="multipart/form-data">
                           <div class="card">
                              ...
                              <div class="card-body">
                                 <div class="row">
                                       <div class="col-xl-3 col-sm-6">
                                          ...
                                          <input class="form-control" type="text"   value="SID<?php echo str_pad($sales->sale_id, 6, '0', STR_PAD_LEFT); ?>" placeholder="Product ID" readonly>

                                          <input class="form-control" type="hidden"   value="<?php echo $sales->sale_id; ?>" name="sale_id">
                                       </div>
                                         ...
                                         <div class="col-xl-3 col-sm-6">
                                          ...
                                          <select class="form-control select2" name="sale_branch_id" id="product_branch_id" required>
                                             <?php if(!empty($getbranchs)){ foreach ($getbranchs as $key => $branchs) { ?>
                                                <option <?php if($sales->sale_branch_id == $branchs->branch_id){ echo "selected"; } ?> value="<?php echo $branchs->branch_id; ?>"> <?php echo $branchs->branch_name; ?></option>
                                           <?php  } } ?>
                                          </select>
                                       </div>
                                        <?php }else{ ?> 
                                      ...
                                      <div class="col-xl-6 col-sm-6">
                                          ...
                                          <select class="form-control select2" name="sales_customer_id" id="sales_customer_id" required>
                                             ...
                                             <?php if(!empty($customers)){ foreach ($customers as $key => $customer) { ?>
                                                <option <?php if($sales->sales_customer_id == $customer->customer_id){ echo "selected"; } ?>  value="<?php echo $customer->customer_id; ?>"> <?php echo $customer->customer_name." - ".$customer->customer_number; ?><?php echo ($customer->customer_remark != "")?" - ".$customer->customer_remark:""; ?></option>
                                           <?php  } } ?>
                                          </select>
                                       </div>
                                       <div class="col-xl-3 col-sm-6">
                                          <label class="col-form-label pt-0">Rent Start Date<sup>*</sup></label>
                                          <input class="form-control" type="date" name="rent_start_date"  placeholder="Rent Start Date" value="<?php echo $sales->rent_start_date; ?>" required>
                                       </div>
                                       <div class="col-xl-3 col-sm-6">
                                          <label class="col-form-label pt-0">No.of.Days Rent<sup>*</sup></label>
                                           <input class="form-control" type="number" step="1" name="no_of_days_rent" id="no_of_days_rent" onchange="allcal()" placeholder="Product Purchase Amount" value="<?php echo $sales->no_of_days_rent; ?>" required>
                                       </div>
                                        <div class="col-xl-3 col-sm-6">
                                          <label class="col-form-label pt-0">Created Date and Time</label>
                                          <input class="form-control" type="text" name="sales_created_on"  placeholder="Category Date Time" value="<?php echo date("m-d-Y h:i:s a", strtotime($sales->sales_created_on)); ?>" readonly>
                                       </div>
                                       <div class="col-xl-12 col-sm-12">
                                          <label class="col-form-label pt-0">Rent Details(if any)</label>
                                          <textarea class="form-control"   name="sales_details"><?php echo $sales->sales_details; ?></textarea>
                                       </div>
                              ...
                              <div class="card-body">
                                 <div class="row">
                                    ...
                                    <table class="table">
                                       ...
                                       <tbody id="AppendSale">
                                          <?php $sno = 0; if(!empty($salesitem)){ foreach ($salesitem as $key => $sitem) { ?>
                                             <?php $sno++; ?>
                                             
                                          <tr id="salerow_<?php echo $sno; ?>">
                                           
                                                <td >
                                                   <select width="100%" class="select2 sale_item_product_id form-control"  name="sale_item_product_id[]" id="sale_item_product_id_<?php echo $sno; ?>" onchange="getproductdetails(<?php echo $sno; ?>)"  required>
                                                      <option value="">Selct Product</option>
                                                      <?php if(!empty($products)){ foreach ($products as $key => $vproduct) { ?>
                                                        <option <?php if($sitem->sale_item_product_id == $vproduct->id){ echo "selected"; } ?> value="<?php echo $vproduct->id; ?>"><?php echo $vproduct->product_name." - ".$vproduct->product_id; ?></option>
                                                     <?php } } ?>
                                                   </select>                                                
                                                </td>
                                                <td><input type="number" class="form-control sale_item_qty" name="sale_item_qty[]" id="sale_item_qty_<?php echo $sno; ?>" onblur="allcal()" value="<?php echo $sitem->sale_item_qty; ?>" step="1" required><span id="sale_item_aqty_<?php echo $sno; ?>" style="color:red"></span></td>

                                                <td><input type="number" class="form-control sale_item_rent" name="sale_item_rent[]" value="<?php echo $sitem->sale_item_rent; ?>" id="sale_item_rent_<?php echo $sno; ?>" readonly></td>

                                                <td><input type="number" class="form-control sale_item_discount" name="sale_item_discount[]" onblur="allcal()" id="sale_item_discount_<?php echo $sno; ?>" value="<?php echo $sitem->sale_item_discount; ?>" required></td>
                                               
                                                <td><input type="number" class="form-control sale_item_amt" name="sale_item_amt[]" value="<?php echo $sitem->sale_item_amt; ?>" id="sale_item_amt_<?php echo $sno; ?>" readonly></td>

                                                <td><button type="button" onclick="deleteSale(<?php echo $sno; ?>)"><i class="fa fa-trash"></i></button></td>
                                          </tr>
                                          <?php } } ?>
                                       </tbody>
                                       <tfoot>
                                          ...
                                          <tr>
                                             <td colspan="4"></td>
                                             <td>Total Rent</td>
                                             <td><input class="form-control" type="text" name="totrent"  placeholder="Total Rent"  value="<?php echo $sales->totrent; ?>"  id="totrent" readonly></td>
                                           
                                          </tr>
                                          <tr>
                                             <td colspan="4"></td>
                                             <td>Product Discount</td>
                                             <td><input class="form-control" type="text" name="totdis"  placeholder="Product Discount" value="<?php echo $sales->totdis; ?>"  id="totdis" readonly></td>
                                             
                                          </tr>
                                          <tr>
                                             <td colspan="4"></td>
                                             <td>Per Day Rent</td>
                                             <td><input class="form-control" type="text" name="perdayrent"  placeholder="Per Day Rent" value="<?php echo $sales->perdayrent; ?>"  id="perdayrent" readonly></td>
                                            
                                          </tr>
                                          <tr>
                                             <td colspan="4"></td>
                                             <td>Total Amount X No.of.days</td>
                                             <td><input class="form-control" type="text" name="totamt"  placeholder="Total Amount X No.of.days" value="<?php echo $sales->totamt; ?>"  id="totamt" readonly ></td>
                                            
                                          </tr>
                                          <tr>
                                             <td colspan="4"></td>
                                             <td>Discount<sup>*</sup></td>
                                             <td><input class="form-control" type="number" name="discount"  placeholder="Discount" onchange="allcal()" value="<?php echo $sales->discount; ?>"  id="discount" required></td>
                                             
                                          </tr>
                                          <tr>
                                             <td colspan="4"></td>
                                             <td>Total Final Amount</td>
                                             <td><input class="form-control" type="text" name="finamt"  placeholder="Total Final Amount" value="<?php echo $sales->finamt; ?>"  id="finamt" readonly>
                                                <input class="form-control" type="hidden" name="rownumber"  id="rownumber" value="<?php echo $sno; ?>" readonly >
                                             </td>
                                          ...
                                          <tr>
                                             ...
                                             <td><input class="form-control" type="text" name="sales_box"  placeholder="Sales Box Number"  value="<?php echo $sales->sales_box; ?>" id="sales_box" required></td>
                                          </tr>

                                           <tr>
                                             <td colspan="4"></td>
                                             <td>Advance Amount<sup>*</sup></td>
                                             <td><input class="form-control" type="number" name="adv_amt"  placeholder="Advance Amount" value="<?php echo $sales->adv_amt; ?>"  step="0.01" id="adv_amt" required></td>
                                          </tr>
                                          <tr>
                                             <td colspan="4"></td>
                                             <td>Deposit Amount<sup>*</sup></td>
                                             <td><input class="form-control" type="number" name="depsoit_amt"  placeholder="Deposit Amount" value="<?php echo $sales->depsoit_amt; ?>" step="0.01" id="depsoit_amt" required></td>
                                          </tr>
                                       </tfoot>
                                    </table>
                                 </div>

...
<html lang="en">
  <head>
    ...
    <meta name="description" content="POS : Login Page">
    <meta name="keywords" content="POS : Login PAGE">
    <meta name="author" content="Musthak : Sharps of Soft Software Solution">
        ...
        <div class="row">
          <div class="col-12">
            <div class="login-card">
              <form class="theme-form login-form" method="post" action="<?php echo base_url() ?>user-login">
                <h4>Login</h4>
                <h6>Welcome back! Log in to your account.</h6>
                <div class="form-group">
                  <label>Email Address</label>
                  <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                    <input class="form-control" name="email_address" type="email" required="" placeholder="Test@gmail.com">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                    ...
                    <!-- <div class="show-hide"><span class="show">Show</span></div> -->
                  </div>
                </div>
                <div class="form-group">
                  <div class="checkbox">
                  ...
                  <!-- <a class="link" href="<?php echo base_url(); ?>comming">Forgot password?</a> -->
                </div>
 <div class="form-group">
                ...
                <!-- <p>Don't have account?<a class="ms-2" href="<?php echo base_url(); ?>comming">Create Account</a></p> -->
              </form>
            </div>
          </div>
        </div>

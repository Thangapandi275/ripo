         ...
         <div class="container-fluid p-0">
            <div class="comingsoon">
               <div class="comingsoon-inner text-center">
                  <a href="index.html"><img src="<?php echo base_url() ?>/assets/images/logo/logo-1.png" alt=""></a>
                  <h5>WE ARE WORKING ON IT COMING SOON</h5>
                  <div class="form-group">
                     <button class="btn btn-primary btn-block" id="goback" type="submit">Go Back</button>
                  </div>

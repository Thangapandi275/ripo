                      ...
                      <div class="col-xl-3 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                              <div class="card income-card card-primary">
                                 <div class="card-body text-center">
                                    ...
                                    <?php $num_prd = $this->common->getproducts(); ?>
                                    <h5><?php echo number_format(count($num_prd)); ?> </h5>
                                    <p>Number of Product With us</p>
                              ...
                              <div class="card income-card card-primary">
                                 <div class="card-body text-center">
                                    ...
                                    $sessionData = $this->session->userdata();
                                          $this->db->select('SUM(instock) as totinstock')->from('cr_products')->where('cr_products.IsDelete',0);
                                          if($sessionData['branch'] != 0){
                                                 $this->db->where('cr_products.product_branch_id',$sessionData['branch']);
                                             }                                              
                                             $totinstock = $this->db->get()->row(); 
                                             
                                           ?>


                                    <h5><?php echo number_format($totinstock->totinstock); ?></h5>
                                    <p>Total Stock IN</p>
                                   <!--  <a class="btn-arrow arrow-primary" href="javascript:void(0)"><i class="toprightarrow-primary fa fa-arrow-up me-2"></i>95.54% </a> -->
                                    <div class="parrten">
                                       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 448.057 448.057" style="enable-background:new 0 0 448.057 448.057;" xml:space="preserve">
                              ...
                              <div class="card income-card card-primary">
                                 <div class="card-body text-center">
                                    <div class="round-box">
                                     ...
                                     <?php 
                                    $sessionData = $this->session->userdata();
                                          $this->db->select('SUM(outstock) as totoutstock')->from('cr_products')->where('cr_products.IsDelete',0);
                                          if($sessionData['branch'] != 0){
                                                 $this->db->where('cr_products.product_branch_id',$sessionData['branch']);
                                             }                                              
                                             $totoutstock = $this->db->get()->row(); 
                                             
                                           ?>


                                    <h5><?php echo number_format($totoutstock->totoutstock); ?></h5>
                                    <p>Total Stock Out</p>
                                    <!-- <a class="btn-arrow arrow-primary" href="javascript:void(0)"><i class="toprightarrow-primary fa fa-arrow-up me-2"></i>95.54% </a> -->
                                    <div class="parrten">
                                       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 448.057 448.057" style="enable-background:new 0 0 448.057 448.057;" xml:space="preserve">
                              ...
                              <div class="card income-card card-primary">
                                 <div class="card-body text-center">
                                    <div class="round-box">
                                     ...
                                     <?php $num_users = $this->common->getusers(); ?>
                                    <h5><?php echo number_format(count($num_users)); ?> </h5>
                                    <p>Total users</p>
                                   <!--  <a class="btn-arrow arrow-primary" href="javascript:void(0)"><i class="toprightarrow-primary fa fa-arrow-up me-2"></i>95.54% </a> -->
                                    <div class="parrten">
                                       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 448.057 448.057" style="enable-background:new 0 0 448.057 448.057;" xml:space="preserve">
...
&lt;/div&gt;</code></pre>
                           ...
                           <?php $getSalesList = $this->common->getSales(); ?>
                           <div class="col-xl-12 ">
                              <div class="card">
                                 <div class="card-body">
                                    <div class="table-responsive">
                                       ...
                                       <table class="table table-bordernone">
                                          ...
                                          <?php $sno = 0; if(!empty($getSalesList)){ foreach ($getSalesList as $key => $sales) { 
                                                   $sno++;                                        
                                             if($sno <= 5){ 
                                                ?>
                                                <tr>
                                                   ...
                                                   <td>                                          
                                                   <a href="<?php echo base_url('sales/viewsales/').$sales->sale_id ?>"><button class="btn btn-sm btn-primary "><i class="fa fa-eye"></i></button></a>
                                                   </td>
                                                </tr>
